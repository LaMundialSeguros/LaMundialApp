...
class BannerPaymentMethod extends StatelessWidget {
  const BannerPaymentMethod({super.key});

  @override
  Widget build(BuildContext context) {
    return Image.asset(
      'assets/methodPayment.png',
      //'lib/images/logo.png', // Ruta a la imagen en tu proyecto
      width: 150.0, // Ancho de la imagen (ajusta según tus necesidades)
      height: 150.0, // Altura de la imagen (ajusta según tus necesidades)
