...
class BancoPlazaFormPage extends StatefulWidget {
  final Policy policy;
  const BancoPlazaFormPage(this.policy,{Key? key}) : super(key: key);
  //const BancoPlazaFormPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  BancoPlazaFormPageState createState() => BancoPlazaFormPageState();
}

class BancoPlazaFormPageState extends State<BancoPlazaFormPage> {
...
// Taker
  FocusNode expirationDateCodeFocus = FocusNode();
  FocusNode identityCardCodeFocus = FocusNode();
  FocusNode nameCodeFocus = FocusNode();
  FocusNode cardNumberCodeFocus = FocusNode();
  FocusNode cvcCodeFocus = FocusNode();
  FocusNode descriptionCodeFocus = FocusNode();
  ...
  List<AccountType> AccountTypes = [
    AccountType('Ahorros',1),
    AccountType('Corriente', 2)
  ];
                        ...
                        Container(
                          ...
                          child: DropdownButtonFormField<AccountType>(
                            ...
                            onChanged: (AccountType? newValue) {
                              setState(() {
                                AccountTypeSelected = newValue;
                              });
                            },
                            items: AccountTypes.map((AccountType AccType) {
